...
# p <- foo(second_visits)
# Go through foo() manually:
# p <- foo(filter(second_visits, `Primary language` != "English")) # errors
# data=filter(second_visits, `Primary language` != "English")
# p <- foo(filter(second_visits, preferred_languages != "en")) # errors
# data=filter(second_visits, preferred_languages != "en")
# p <- foo(filter(second_visits, `Number of Accept-Languages` > 1)) # errors
# data=filter(second_visits, `Number of Accept-Languages` > 1)
