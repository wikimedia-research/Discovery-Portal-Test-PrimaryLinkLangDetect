...
author: Mikhail Popov (Analysis & Reporting), Jan Drewniak (UX Engineering), Deborah
  Tankersley (Product Management), Trey Jones (Review)
date: "April 20, 2016"
fontsize: 11pt
...
Figures \ref{fig:visits_all}--\ref{fig:visits_multilang} and Tables \ref{table:visits_all}--\ref{table:visits_multilang} below summarize the statistical comparisons of the test group against the controls. "\% Diff" refers to --- for example --- "$\pi_\text{B}$ who visited Wikipedia in a preferred language \textbf{\emph{minus}} $\pi_\text{A}$ who visited Wikipedia in a preferred language", with positive numbers indicating that the proability of a successful outcome is greater in B than A. Relative risk is interpreted as "$X$ times more likely to visit Wikipedia in a preferred language" ($RR = \pi_\text{B}/\pi_\text{A}$) and odds ratio is interpreted as "the odds of group B users visiting Wikipedia in a preferred language are $X$ times the odds of group A users" ($OR = (\pi_\text{B}/(1-\pi_\text{B}))/(\pi_\text{A}/(1-\pi_\text{A}))$).
...
Prim & A-L doesn't include En & one of preferred & 515 & 489 & 69.4 (65.4, 73.3) & 53.3 (49.0, 57.7) & 16.1 (9.9, 21.8) & 1.30 (1.18, 1.44) & 2.01 (1.51, 2.54)\\
\hline
\rowcolor{LightYellow}
Prim & A-L doesn't include En & most preferred & 515 & 489 & 68.9 (64.8, 72.8) & 53.3 (49.0, 57.7) & 15.5 (9.4, 21.2) & 1.29 (1.17, 1.43) & 1.95 (1.47, 2.46)\\
\hline
Prim & A-L includes En & one of preferred & 1.8K & 1.8K & 91.1 (89.7, 92.4) & 90.7 (89.3, 92.0) & 0.4 (-1.5, 2.3) & 1.00 (0.98, 1.03) & 1.06 (0.83, 1.31)\\
\hline
Prim & A-L includes En & most preferred & 1.8K & 1.8K & 80.2 (78.3, 82.0) & 78.3 (76.4, 80.2) & 1.9 (-0.7, 4.6) & 1.02 (0.99, 1.06) & 1.13 (0.95, 1.31)\\
\hline
Sec & A-L doesn't include En & one of preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L doesn't include En & most preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L includes En & one of preferred & 65 & 62 & 29.9 (19.3, 41.0) & 39.1 (27.7, 51.1) & -9.2 (-25.1, 6.9) & 0.78 (0.42, 1.17) & 0.71 (0.26, 1.25)\\
\hline
Sec & A-L includes En & most preferred & 65 & 62 & 22.4 (12.5, 32.2) & 28.1 (17.2, 38.7) & -5.7 (-19.7, 10.0) & 0.83 (0.38, 1.35) & 0.80 (0.27, 1.48)\\
\hline
\end{tabular}
...
\begin{table}
\sffamily
\caption{Statistical comparisons of test group vs controls with respect to language of the Wikipedia they visited through a primary or secondary link, excluding users whose most preferred language is English. Values in parentheses represent 95\% Bayesian Confidence Intervals -- meaning there is a 95\% probability the value of interest is inside the interval. ("Prim" = primary link, "Sec" = secondary link)}
\centering
\renewcommand{\arraystretch}{1.5}% for the vertical padding
\begin{tabular}[t]{l|l|l|l|l|l|l|l|l|l}
\hline
...
Prim & A-L doesn't include En & most preferred & 515 & 489 & 68.9 (64.8, 72.8) & 53.3 (49.0, 57.7) & 15.5 (9.4, 21.2) & 1.29 (1.17, 1.43) & 1.95 (1.47, 2.46)\\
\hline
Prim & A-L includes En & one of preferred & 433 & 399 & 95.6 (93.6, 97.5) & 96.3 (94.3, 97.9) & -0.6 (-3.3, 2.1) & 0.99 (0.97, 1.02) & 0.90 (0.34, 1.55)\\
\hline
\rowcolor{LightYellow}
Prim & A-L includes En & most preferred & 433 & 399 & 57.5 (52.8, 62.1) & 46.2 (41.3, 50.9) & 11.3 (4.6, 18.2) & 1.25 (1.09, 1.42) & 1.59 (1.17, 2.04)\\
\hline
Sec & A-L doesn't include En & one of preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L doesn't include En & most preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L includes En & one of preferred & 17 & 17 & 63.1 (42.4, 84.1) & 57.8 (36.0, 78.5) & 5.3 (-24.5, 35.1) & 1.14 (0.59, 1.77) & 1.60 (0.16, 3.99)\\
\hline
Sec & A-L includes En & most preferred & 17 & 17 & 47.4 (26.3, 69.8) & 31.6 (12.5, 52.0) & 15.8 (-14.5, 44.3) & 1.70 (0.56, 3.32) & 2.59 (0.21, 6.43)\\
\hline
\end{tabular}
...
\begin{table}
\sffamily
\caption{Statistical comparisons of test group vs controls with respect to language of the Wikipedia they visited through a primary or secondary link, excluding users whose only preferred language is English. Values in parentheses represent 95\% Bayesian Confidence Intervals -- meaning there is a 95\% probability the value of interest is inside the interval. ("Prim" = primary link, "Sec" = secondary link)}
\centering
\renewcommand{\arraystretch}{1.5}% for the vertical padding
\begin{tabular}[t]{l|l|l|l|l|l|l|l|l|l}
\hline
...
Prim & A-L doesn't include En & most preferred & 515 & 489 & 68.9 (64.8, 72.8) & 53.3 (49.0, 57.7) & 15.5 (9.4, 21.2) & 1.29 (1.17, 1.43) & 1.95 (1.47, 2.46)\\
\hline
Prim & A-L includes En & one of preferred & 519 & 474 & 95.8 (94.0, 97.4) & 96.2 (94.5, 97.8) & -0.4 (-2.8, 2.0) & 1.00 (0.97, 1.02) & 0.94 (0.40, 1.57)\\
\hline
\rowcolor{LightYellow}
Prim & A-L includes En & most preferred & 519 & 474 & 58.3 (54.1, 62.6) & 50.2 (45.6, 54.5) & 8.2 (2.1, 14.4) & 1.16 (1.03, 1.30) & 1.40 (1.06, 1.77)\\
\hline
Sec & A-L doesn't include En & one of preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L doesn't include En & most preferred & 44 & 46 & 10.9 (2.8, 19.8) & 25.0 (13.4, 36.9) & -14.1 (-28.8, 1.5) & 0.46 (0.09, 0.93) & 0.41 (0.06, 0.92)\\
\hline
Sec & A-L includes En & one of preferred & 21 & 21 & 60.8 (41.5, 80.4) & 60.8 (40.7, 79.1) & 0.1 (-26.9, 26.7) & 1.03 (0.58, 1.54) & 1.21 (0.19, 2.78)\\
\hline
Sec & A-L includes En & most preferred & 21 & 21 & 39.2 (19.6, 58.5) & 30.5 (13.2, 48.9) & 8.7 (-18.9, 35.0) & 1.43 (0.46, 2.75) & 1.85 (0.27, 4.42)\\
\hline
\end{tabular}
...
\begin{table}
\sffamily
\caption{Statistical comparisons of test group vs controls with respect to language of the Wikipedia they visited through a primary or secondary link, looking at multilingual users only. Values in parentheses represent 95\% Bayesian Confidence Intervals -- meaning there is a 95\% probability the value of interest is inside the interval. ("Prim" = primary link, "Sec" = secondary link)}
\centering
\renewcommand{\arraystretch}{1.5}% for the vertical padding
\begin{tabular}[t]{l|l|l|l|l|l|l|l|l|l}
\hline
...
Prim & A-L includes En & most preferred & 519 & 474 & 58.3 (54.1, 62.6) & 50.2 (45.6, 54.5) & 8.2 (2.1, 14.4) & 1.16 (1.03, 1.30) & 1.40 (1.06, 1.77)\\
\hline
Prim & Combined (Not split by Eng. & one of preferred & 526 & 475 & 95.1 (93.2, 96.9) & 96.0 (94.2, 97.7) & -0.9 (-3.5, 1.6) & 0.99 (0.96, 1.02) & 0.84 (0.40, 1.37)\\
\hline
\rowcolor{LightYellow}
Prim & Combined (Not split by Eng. & most preferred & 526 & 475 & 57.6 (53.3, 61.8) & 50.1 (45.5, 54.4) & 7.5 (1.5, 13.9) & 1.15 (1.02, 1.29) & 1.36 (1.02, 1.70)\\
\hline
Sec & A-L includes En & one of preferred & 21 & 21 & 60.8 (41.5, 80.4) & 60.8 (40.7, 79.1) & 0.1 (-26.9, 26.7) & 1.03 (0.58, 1.54) & 1.21 (0.19, 2.78)\\
\hline
Sec & A-L includes En & most preferred & 21 & 21 & 39.2 (19.6, 58.5) & 30.5 (13.2, 48.9) & 8.7 (-18.9, 35.0) & 1.43 (0.46, 2.75) & 1.85 (0.27, 4.42)\\
\hline
Sec & Combined (Not split by Eng. & one of preferred & 21 & 21 & 60.8 (41.5, 80.4) & 60.8 (40.7, 79.1) & 0.1 (-26.9, 26.7) & 1.03 (0.58, 1.54) & 1.21 (0.19, 2.78)\\
\hline
Sec & Combined (Not split by Eng. & most preferred & 21 & 21 & 39.2 (19.6, 58.5) & 30.5 (13.2, 48.9) & 8.7 (-18.9, 35.0) & 1.43 (0.46, 2.75) & 1.85 (0.27, 4.42)\\
\hline
\end{tabular}
