...
Under the conjugate Beta-Binomial model, each $i$-th group's number of successful outcomes $y_i$ follows a Binomial distribution with a Beta prior on the probability of success parameter $\pi_i$:
